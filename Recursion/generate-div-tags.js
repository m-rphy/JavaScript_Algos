/*
Write a function that takes in a positive integer numberOfTags
and returns a list of all the valid strings that you can generate
with that number of matched <div></div>

*/

// Approach: Brute-froce approach would be to generate all possible 
// combinations and then check if valid
