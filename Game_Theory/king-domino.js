// # In the game of Kingdomino, players create kingdoms with 
// domino tiles, and at the end of the game you might arrive 
// at a kingdom that looks like above. Each contiguous block 
// of the same type of tile is a property, and the value of 
// each property is the size of it multiplied by the number 
// of crowns within it. The entire kingdom's score is the sum 
// of the scores of each property within it. The castle isn't 
// worth points. A kingdom will never be larger than 5x5, and it could have holes.
